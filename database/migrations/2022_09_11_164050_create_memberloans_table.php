...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('memberloans', function (Blueprint $table) {
            $table->id();
            $table->integer('member_id')->unsigned()->references('id')->on('employees')->onDelete('restrict');
    ...
    {
        Schema::dropIfExists('memberloans');
    }
};
