    ...
    <div class="w-full px-3 mb-6 md:mb-0">
        ...
        <select wire:model.defer="type" class="block appearance-none w-full bg-gray-100 border @error('type') border-red-500  @enderror border-gray-500 text-gray-700 py-2 mb-2 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
